# Linear_monthly_milk_production_forecasting.py
"""
Using a simple linear model for
...
#
# test results:
#   - AdamW is not better than Adam with LogCosh: variance of errors of all 50 models is higher; mean is about the same
#
#
# to-do:
#   - 
...
TITLE = "Simple one-layer linear model for time series forecasting"
...
LOSS_LIMIT        = 1.0  # also good for LogCosh
...
# end of Linear_monthly_milk_production_forecasting.py
