...
..I got the idea to experiment with kernel sizes ("model comparison"). That's why I have written this small utility: ./DLinear_monthly_milk_production_moving_averages.py
